...
- 为实现删除功能模拟，创建data.json进行数据的储存和引入，但注意实际浏览器无法操作本地文件。
---
...
---
## 开发总结
- 绝大部分编码直接编写，组件使用参考官方文档提供的组件代码，部分复杂内容（Echart实现柱状图）在参考官方文档的同时，使用AI辅助快速理解和开发。
# 个人对AI辅助编程的看法
### 现状
对普通人而言，现在的大语言模型已经能够根据提示词完成简单工具开发，即使是0代码基础的普通人也可以在大模型的引导下完成像样的完整小项目。
对程序员，部分AI辅助编程的插件已经集成到开发工具中，能够对已有代码进行分析和联想，帮助程序员提高效率。
### 个人看法
- 首先，从效率层面看，即使同样使用AI辅助，完成相同的程序，程序员必然要比普通人的效率更快。
- 其次，程序员重要的不只是代码能力，还有业务能力。在实际开发任务中，项目的开发往往由多个组多个程序员共同完成，整个项目会被拆成多个部分，了解整体项目和个人负责的部分的业务需求，考虑具体的应用场景，多部门的合作，对功能进行补充和修正，同样需要花费许多时间和经历。
- 这样子看，AI也仅仅是工具，不同人使用工具的效率不同，工具也无法完全替代"人"。
- 但是，AI对于开发效率的提升是显著的，对于有能力有经验的程序员来说，使用AI可以避免"重复造轮子"带来的时间浪费，对于新手程序员，使用AI也可以帮助新手更快理解和上手新工具，而我们需要注意的是，即使使用AI辅助开发，程序员应当依旧为主导，而不是沦为AI的"配角"，使自身的学习和提升停滞。